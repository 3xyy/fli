...
export default function AboutUs() {
  ...
  return (
    <section id="about" className="relative py-20 md:py-24 bg-transparent">
      <ScrollAnimation>
        <div className="flex overflow-x-auto w-full" style={{scrollSnapType: 'x mandatory'}}>
          ...
          <button
            className="absolute top-6 right-8 z-10 bg-white text-black font-medium px-6 py-2.5 text-sm rounded-md hover:bg-gray-100 transition-colors flex items-center gap-2 group focus:outline-none focus:ring-2 focus:ring-gray-900 focus:ring-offset-2"
            onClick={() => {
          ...
          <div className="max-w-4xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold text-center mb-16 mt-8 text-white">Who Are We</h2>

            <div className="mb-12 glass-card rounded-2xl p-8 md:p-10">
              <h3 className="text-2xl md:text-3xl font-semibold text-white mb-6">Our Mission</h3>
            ...
            <div className="mb-12 glass-card rounded-2xl p-8 md:p-10">
              ...
              <div className="mt-16">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  >
                    <h3 className="text-xl font-semibold text-white mb-3">Student-Driven Approach</h3>
                  ...
                  <div className="glass-card p-8 rounded-xl">
                    <h3 className="text-xl font-semibold text-white mb-3">Real Entrepreneurial Experience</h3>
                    <p className="text-gray-300">
        ...
        <div id="team-section" className="w-screen px-6 lg:px-8 flex-shrink-0 relative bg-transparent" style={{scrollSnapAlign: 'start'}}>
          ...
          <button
            className="absolute top-6 left-8 z-10 bg-white text-black font-medium px-6 py-2.5 text-sm rounded-md hover:bg-gray-100 transition-colors flex items-center gap-2 group focus:outline-none focus:ring-2 focus:ring-gray-900 focus:ring-offset-2"
            onClick={() => {
          ...
          <div className="max-w-6xl mx-auto">
            <h2 className="text-4xl md:text-5xl font-bold text-center mb-16 mt-8 text-white">Meet Our Team</h2>
              ...
              <div className="grid grid-cols-3 gap-6 mb-8 w-full">
                ...
                {teamMembers.slice(0,3).map((member) => (
                  <div key={member.name} className="flex flex-col items-center glass-card rounded-xl p-8 min-h-[200px] w-full transition-all duration-200 hover:scale-[1.02] relative">
                    <h4 className="text-2xl font-semibold text-white mb-2 text-center break-words w-full">{member.name}</h4>
                    <span className="absolute bottom-8 left-1/2 transform -translate-x-1/2 text-base font-medium text-gray-300 text-center w-full">{member.role}</span>
                  </div>
                ))}
              </div>
            </div>
              ...
              <div className="grid grid-cols-5 gap-4 w-full">
                ...
                {[
                  ...
                  <div key={member.name} className="flex flex-col items-center glass-card rounded-xl p-6 min-h-[180px] w-full transition-all duration-200 hover:scale-[1.02] relative">
                    <h4 className="text-xl font-semibold text-white mb-2 text-center break-words w-full">{member.name}</h4>
                    <span className="absolute bottom-6 left-1/2 transform -translate-x-1/2 text-sm font-medium text-gray-300 text-center w-full">{member.role}</span>
                  </div>
                ))}
              </div>
            </div>
              ...
              <div className="grid grid-cols-6 gap-4 w-full">
                ...
                {[
                  ...
                  <div key={member.name} className="flex flex-col items-center glass-card rounded-xl p-6 min-h-[160px] w-full transition-all duration-200 hover:scale-[1.02] relative">
                    <h4 className="text-lg font-semibold text-white mb-2 text-center break-words w-full">{member.name}</h4>
                    <span className="absolute bottom-6 left-1/2 transform -translate-x-1/2 text-sm font-medium text-gray-300 text-center w-full">{member.role}</span>
                  </div>
                ))}
              </div>
