...
export default function Registration() {
  ...
  useEffect(() => {
    ...
    // Poll for window.turnstile if not available
    if (typeof window !== 'undefined') {
      let tries = 0;
      const poll = () => {
        if (window.turnstile) {
          renderTurnstile();
        } else if (tries < 50) { // try for 5 seconds
          tries++;
          setTimeout(poll, 100);
        }
      };
      ...
      <div className="container mx-auto px-4">
        ...
        <div id="registration">
          ...
          <p className="text-center text-gray-700 mb-10 max-w-3xl mx-auto">
            Registration for the FLI Basics of Business 1 course. Classes will take place every Saturday at 9-10 am from 10/11/2025 to 1/31/2026.
          </p>
