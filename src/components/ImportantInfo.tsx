    ...
    <section className="py-20 md:py-24 bg-transparent">
      <div className="container mx-auto px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <h2 className="text-4xl md:text-5xl font-bold text-center mb-16 text-gray-900">Other Important Information</h2>

          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="glass-card rounded-xl p-8 transition-all duration-200 hover:scale-[1.02]">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900">Homework Expectations</h3>
              </div>
            ...
            <div className="glass-card rounded-xl p-8 transition-all duration-200 hover:scale-[1.02]">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900">Zoom Verification</h3>
              </div>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="glass-card rounded-xl p-8 transition-all duration-200 hover:scale-[1.02]">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900">Free Classes</h3>
              </div>
              <p className="text-gray-600 leading-relaxed">
            ...
            <div className="glass-card rounded-xl p-8 transition-all duration-200 hover:scale-[1.02]">
              <div className="flex items-center mb-4">
                ...
                <h3 className="text-xl font-semibold text-gray-900">Project Expectations</h3>
              </div>
              <p className="text-gray-600 leading-relaxed">
