      ...
      <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white py-12">
        <div className="container mx-auto px-4">
          <div className="bg-blue-100 border border-blue-300 rounded-lg p-6 mb-8 max-w-2xl mx-auto">
            ...
            <p className="mb-2">There will be a total of 7 sessions (completely <span className="rainbow-move-text">free</span>). Each session will be <b>weekly</b> on <b>Friday at 8 PM</b> beginning on <b>August 10th, 2025</b> to <b>September 21st, 2025</b>.</p>
