      ...
      <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white py-12">
        <div className="container mx-auto px-4">
          <div className="bg-blue-100 border border-blue-300 rounded-lg p-6 mb-8 max-w-2xl mx-auto">
            ...
            <p className="mb-2">There will be a total of 7 sessions (completely <span className="rainbow-move-text">free</span>). Each session will be <b>weekly</b> on <b>Sunday at 8 PM</b> beginning on <b>August 10th, 2025</b> to <b>September 21st, 2025</b>.</p>
            <p className="mb-2">Here is a link to a document containing the course outline (week-by-week): <a href="https://docs.google.com/document/d/1uvFINCp85JAi0u_085hcxiXIyN-OQYlvSXjufKcJLp4/edit?usp=sharing" className="text-blue-700 underline" target="_blank" rel="noopener noreferrer">Course Outline</a>. All classes will be occuring online on Zoom!</p>
            ...
            <p className="mb-2">While previous experience in Python or a coding language is not required, you should be familiar with your operating system (Windows / Mac) and know how to do basic file operations (ex. copying files / moving files).</p>
            <p className="mt-6 text-blue-900 font-semibold text-center">Find more information at: <a href="https://www.pixelmindlearning.org" className="underline text-blue-700" target="_blank" rel="noopener noreferrer">pixelmindlearning.org</a></p>
          </div>
          <PixelmindsForm />
        </div>
      </div>
